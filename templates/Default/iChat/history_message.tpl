<div class="chat">
   ...
   <span style="color:#2a2a2a">
      ...
      <div align="right">
         ...
         [allow_edit]<img class="edit_buttons" onclick="iChatEdit('{id}','history'); return false;" src="{THEME}/img/edit.png" alt="Edytuj"/>[/allow_edit]
         [allow_delete]<img class="edit_buttons" onclick="iChatDelete('{id}','history'); return false;" src="{THEME}/img/delete.png" alt="Usuń"/>[/allow_delete]
      </div>
   </span>
</div>